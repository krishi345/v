        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center">
              Consumer <span className="text-primary">Registration</span>
            </h1>
            <p className="text-lg text-center text-foreground/80 mb-8">
              Register as a consumer to purchase fresh agricultural products
            ...
            {success ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 md:p-8 text-center">
                ...
                <p className="text-green-700 mb-6">
                  Thank you for registering with KrishiMitra. You can now browse
                  and purchase products from our farmers.
                </p>
                <a
